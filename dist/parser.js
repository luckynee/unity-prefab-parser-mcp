 ...
 */
export async function parseUnityYAML(filePath) {
 ...
 */
export function parseUnityYAMLContent(content) {
    const documents = [];
 ...
 */
function parseYAMLDocument(docContent, className) {
 ...
 */
export function getClassId(className) {

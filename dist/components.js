...
export const FIELD_ABBREVIATIONS = {
    // Transform
    'localPosition': 'lPos',
    'localRotation': 'lRot',
    'localScale': 'lScale',
...
export const DEFAULT_RENDERING_VALUES = {
    // Renderer properties
    dynamicOccludee: 1,
    m_DynamicOccludee: 1,
    motionVectors: 1,
 ...
 */
export function isDefaultOffset(key, value) {
 ...
 */
export function isBooleanField(fieldName) {
 ...
 */
export function isDefaultRenderingValue(fieldName, value) {
 ...
 */
export function isDefaultTransformValue(fieldName, value) {
 ...
 */
export function getComponentFilter(componentType) {
    return INSPECTOR_FIELDS[componentType] || INSPECTOR_FIELDS.MonoBehaviour;
}
/**
 * Check if a field should be excluded
 */
export function shouldExcludeField(fieldName, componentType) {
 ...
 */
export function renameField(fieldName, componentType, abbreviate = false) {
    const filter = getComponentFilter(componentType);
